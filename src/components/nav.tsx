...
const Nav: FC<Props> = memo(({currentProject: currentProject, contentHeight: contentHeight}) => {

    const projectsList = [
        ["React Portfolio", "/logo.png", "https://github.com/awpoch/react-resume", "not selected"],
    ...
    const handleMouseEnter0 = () => { if(projectsList[0][3] == "not selected") setIsHover0(true); };
    const handleMouseEnter1 = () => { if(projectsList[1][3] == "not selected") setIsHover1(true); };
    const handleMouseEnter2 = () => { if(projectsList[2][3] == "not selected") setIsHover2(true); };
    const handleMouseEnter3 = () => { if(projectsList[3][3] == "not selected") setIsHover3(true); };
    const handleMouseEnter4 = () => { if(projectsList[4][3] == "not selected") setIsHover4(true); };
    const handleMouseEnter5 = () => { if(projectsList[5][3] == "not selected") setIsHover5(true); };
    const handleMouseEnter6 = () => { if(projectsList[6][3] == "not selected") setIsHover6(true); };
    const handleMouseEnter7 = () => { if(projectsList[7][3] == "not selected") setIsHover7(true); };
    const handleMouseEnter8 = () => { if(projectsList[8][3] == "not selected") setIsHover8(true); };
    const handleMouseEnter9 = () => { if(projectsList[9][3] == "not selected") setIsHover9(true); };
    const handleMouseEnter10 = () => { if(projectsList[10][3] == "not selected") setIsHover10(true); };

    const handleMouseLeaveReturn = () => { setIsHoverReturn(false); };
    const handleMouseLeave0 = () => { if(projectsList[0][3] == "not selected") setIsHover0(false); };
    const handleMouseLeave1 = () => { if(projectsList[1][3] == "not selected") setIsHover1(false); };
    const handleMouseLeave2 = () => { if(projectsList[2][3] == "not selected") setIsHover2(false); };
    const handleMouseLeave3 = () => { if(projectsList[3][3] == "not selected") setIsHover3(false); };
    const handleMouseLeave4 = () => { if(projectsList[4][3] == "not selected") setIsHover4(false); };
    const handleMouseLeave5 = () => { if(projectsList[5][3] == "not selected") setIsHover5(false); };
    const handleMouseLeave6 = () => { if(projectsList[6][3] == "not selected") setIsHover6(false); };
    const handleMouseLeave7 = () => { if(projectsList[7][3] == "not selected") setIsHover7(false); };
    const handleMouseLeave8 = () => { if(projectsList[8][3] == "not selected") setIsHover8(false); };
    const handleMouseLeave9 = () => { if(projectsList[9][3] == "not selected") setIsHover9(false); };
    const handleMouseLeave10 = () => { if(projectsList[10][3] == "not selected") setIsHover10(false); };
    ...
    return  <nav key={contentHeight} style={{
