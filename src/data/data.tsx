...
export const skills: SkillGroup[] = [
	{
		...
		skills: [
			...
			{ name: "Self-Directed Learning", level: 8 },
		],
	},
	{
		name: "Electronics & Hardware",
		skills: [
			{ name: "Soldering & Electronics Bench Work", level: 7 },
			{ name: "Custom PCB Design (KiCad)", level: 6 },
			{ name: "Microcontroller Embedded Firmware (C/C++)", level: 7 },
			{ name: "LED Driver Systems & PWM Control", level: 7 },
			{ name: "Electrical Schematics & Circuit Reading", level: 6 },
		],
	},
	{
		name: "Languages, Frameworks & Libraries",
		skills: [
			{ name: "React, React Native, Next.js, Node.js", level: 8 },
			{ name: "JavaScript, TypeScript, HTML, CSS", level: 8 },
			{ name: "C, C++, C#, Python", level: 7 },
			{ name: "REST APIs, MySQL, Express.js, Prisma ORM", level: 7 },
			{ name: "Java, Kotlin (Android)", level: 6 },
		],
	},
	{
		name: "Dev Tools, Cloud & DevOps",
		skills: [
			{ name: "VS Code, Git Version Control", level: 8 },
			{ name: "AI-Assisted Development", level: 8 },
			{ name: "Docker, Docker Compose", level: 7 },
			{ name: "Linux & Windows CLIs", level: 7 },
			{ name: "AWS, Terraform & CI/CD Pipelines", level: 6 },
		],
	},
];
...
/** Number of portfolio items shown before the "View more" button is clicked */
export const portfolioInitialCount = 5;

export const portfolioItems: ProjectItem[] = [
	{
		title: "LumaWave LED Controller + Webstore",
		description: (
			<>
				I designed and built a custom LED lighting controller for aquariums and vivariums. Everything from the
				custom PCB to the software. It connects to your home WiFi and is accessible from any browser. You can
