  ...
  description: (
    <>
      ...
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        ...
        electronics, and working on cars.
      </p>
    </>
  ),
  actions: [
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        U of U has been great for teaching a broad understanding computers, not just how to code. Things like
        networking, compilers, interpreters, algorithms, memory allocation, Boolean logic, and advanced math.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        SLCC was great for getting the majority of my generals completed and learning basic programming skills like how
        loops work, binary numbering, floating point values, data structures, and basic web development.
      </p>
    ),
  },
];
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Sorenson communications provides video to telephone interpretive services for the deaf. I monitered and
        maintained their on-prem/cloud infrastructure, tested their apps/services, and facilitated incident management.
        I was offered a full time position but decided to finish up my CS degree at University of Utah.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        I directed a team of associates in completing services. I performed multiple tasks for local businesses, and
